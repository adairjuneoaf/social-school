import { CardsAboutProject, Container, DescriptionAboutProject, Grid, ImageAboutProject } from "./styles";
...
export function AboutProject() {
  return (
    <Container>
      <Grid>
        <DescriptionAboutProject className="section-description">
        ...
        <ImageAboutProject className="section-image">
          <img src={ImageProject} alt="Ilustração do projeto Social School" />
        </ImageAboutProject>
      </Grid>
      <CardsAboutProject className="section-cards">
        ...
        <motion.div whileHover={{ scale: 0.98, transition: { duration: 0.2 } }}>
          ...
          <h2>Video Aulas</h2>
          <p>Não só de áudio vivemos. Tenha acesso também há diversas video aulas dos mais variados conteúdos.</p>
        </motion.div>
        <motion.div whileHover={{ scale: 0.98, transition: { duration: 0.2 } }}>
